...
spa.model=(function() {
	...
	people = (function(){
		...
		//Its public method includes: join( user can join and leave the chatroom)
		...
		chat = (function(){
			...
			send_msg = function(msg_text){
				...
				//we published updatechat so we can show our outoing messages
			...
			//avatar_update_map should be the form:
