...
spa.fake=(function() {
    ...
    var peopleList,fakeIdSerial, makeFakeId, mockSio, fakeIdSerial = 5;
    ...
    mockSio = (function(){
        ...
        emit_sio = function(msg_type, data){
            ...
            //Respond to 'updatechat' event with an 'updatechat' callback afer a 2s
            //delay. Echo back user info.
            ...
            if(msg_type === 'leavechat'){
                //clear the callbacks used by chat--user has signed out
                //reset login status
